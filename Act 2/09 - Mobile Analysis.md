...
> [!WARNING]
> When downloading 7-zip make sure you use the correct link. The URI 7zip[dot]org uses an invalid certificate. The real website is 7-zip[dot]org not 7zip[dot]org. Additionally, there exists a critical vulnerability in 7-zip versions prior to version 24.07, in which the act of extracting a specially crafted, malicious compressed file can lead to compromise of your computer. 
> 
